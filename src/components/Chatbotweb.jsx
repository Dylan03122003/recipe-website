...
export default function Chatbotweb() {
    ...
    const steps = [
        {
            id: 'Greet',
            message: "Hello! I'm FoodieBot, you can call me 'Foodie'. How can I help you today?",
            trigger: "Ask Name"
        },
        {
            id: "Ask Name",
        ...
        },
        {
            id: "issues",
            options: [
                { value: "introduce about the website?", label: "introduce about the website?", trigger: "website" },
                { value: "suggest some delicious recipes", label: "suggest some delicious recipes", trigger: "food2" },
            ]
        },
        {
            id: 'website',
        ...
        },
        {
            id: "webpage",
            options: [
                { value: "where to view recipes?", label: "where to view recipes?", trigger: "recipes" },
                { value: "how to contact us?", label: "how to contact us", trigger: "contact" },
        ...
        },
        {
            ...
            options: [
                ...
                { value: "special occasion or holiday dishes", label: "special occasion or holiday dishes", trigger: "holiday" }
            ]
        },
        ...
        {
            id: "food4",
            message: "You can check out the detailed recipe of this dish right on our homepage.",
            trigger: "food5"
        },
        {
            id: "food5",
        ...
        {
            id: 'exit',
            message: 'Thank you for visiting Foodieland and chatting with me. Have a delicious meal!',
            end: true
        },
    ];
    ...
    return (
        <div>
            <img
                ...
                alt=""
                className='fixed top-[50%] w-[50px] right-0'
