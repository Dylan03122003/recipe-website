  ...
  return (
    <div class="pt-12">
      ...
      <div className="grid lg:grid-cols-6 gap-x-8 max-w-6xl mx-auto md:grid-cols-3 sm:grid-cols-1 ">
        ...
        <a href="#" className="rounded-3xl bg-gradient-to-b from-transparent via-white to-[#7082461A] pt-3">
          <Grid
            srcs={[
               breakfast1
            ]}
        ...
        <a href="#" className=" rounded-3xl bg-gradient-to-b from-transparent  via-white to-[#6CC63F1A] pt-3">
          <Grid
            srcs={[
              vegan1
           ]}
        ...
        <a href="#" className="rounded-3xl bg-gradient-to-b from-transparent  via-white to-[#CC261B1A] pt-3">
          <Grid
            srcs={[
              meat1
           ]}
        ...
        <a href="#" className="rounded-3xl bg-gradient-to-b from-transparent via-white to-[#F09E001A] pt-3">
          <Grid
            srcs={[
              dessert1
           ]}
        ...
        <a href="#" className=" rounded-3xl bg-gradient-to-b from-transparent via-white to-[#0000000D] pt-3">
          <Grid
            srcs={[
              lunch1
           ]}
